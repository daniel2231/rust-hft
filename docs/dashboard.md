...
- **수익률 (Paper)** — 실현 PnL, 수익률(실현 PnL / 총 매수 대금), 미실현 PnL(현재 best bid 기준 mark-to-market), 보유 포지션 수량, 평균 진입가, 그리고 최근 5분간의 총 PnL(실현+미실현) 곡선 차트. 체결마다 FIFO 매칭으로 갱신되며 1초마다 push됩니다
